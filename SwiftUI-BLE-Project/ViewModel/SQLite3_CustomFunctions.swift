...
extension DBManager {
    ...
    func setupDatabase() -> Bool {
        ...
        if dropTable(name: "cardTypes") {
            if createCardTypesTable() {
                ...
                result_type_1 = insertCardType(name: "Mifare Classic 4K")
        ...
        if dropTable(name: "cardSecurityProfiles") {
            if createKeyProfileTable() {
                ...
                if result_type_0 > 0 {
                    print("DB_SETUP: Default 1K profile created")
                }
                
                result_profile_id_1 = insertSecurityKeyProfiles(name: "Playground Mifare Classic 1K", typeID: Int32(result_type_0))
        ...
        if dropTable(name: "cardSecurityKeys") {
            ...
            if createSecurityKeysTable() {
                ...
                for index:Int32 in 0..<16 {
                    ...
                    print("DB Setup: Default Insert into Keys completed successfully with id \(insert_id)")
                }
                ...
                for index:Int32 in 0..<16 {
                    ...
                    print("DB Setup: Playground Insert into Keys completed successfully with id \(insert_id)")
                }
    ...
    func update_keys(keys_table:[cardSecurityKeysTable]) -> Bool {
        ...
        for index in 0..<(keys_table.count) {
            ...
            result = UpdateSecurityKeySet(id: keys_table[index].id, profileID: keys_table[index].profileID, sectorNum: keys_table[index].sectorNum, keyA: keys_table[index].keyA, keyB: keys_table[index].keyB, accessPermissions: keys_table[index].accessPermissions)
